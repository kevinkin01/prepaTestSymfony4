...
class Sections
{
     ...
     * @var string
     *
     * @ORM\Column(name="thetilteld", type="string", length=80, nullable=false)
     */
    private $thetilteld;
    ...
    public function getThetilteld(): ?string
    {
        return $this->thetilteld;
    }

    public function setThetilteld(string $thetilteld): self
    {
        $this->thetilteld = $thetilteld;
